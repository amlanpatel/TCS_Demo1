...
public class EmployeeDaoJavaImpl implements EmployeeDao {
	...
	static {
		employees.add(new Employee(1,"Amlan","amlan@gmail.com", 100.0));
		employees.add(new Employee(2, "Kumar", "kumar@gmail.com", 200.0));
		employees.add(new Employee(3, "Patel", "patel@gmail.com", 300.001));
	}
